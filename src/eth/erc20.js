...
class ERC20 {
    constructor(address, symbol, decimal = 18) {
        // const nowProviders = new ethers.providers.Web3Provider(window.ethereum, 128)
        // this.signer = nowProviders.getSigner(0);
        const rpcUrl =  'https://http-mainnet-node.defibox.com'
        const nowProviders = new ethers.providers.JsonRpcProvider(rpcUrl);
        // this.signer = nowProviders.getSigner();
        this.contract = new Contract(address, ABI, nowProviders);
